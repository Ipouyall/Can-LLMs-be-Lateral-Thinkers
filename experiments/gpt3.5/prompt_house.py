...
A riddle is a question or statement intentionally phrased, \
so as to require ingenuity in ascertaining its answer or meaning. \
...
Different ideas can be used in riddles to trick you:
    ...
    11. Riddle may try to present something impossible or in contradiction with the reality. \
    Just consider alternative perspectives.
Although a clever solution is required, avoid supernatural solutions \
and keep your answer within the limits of realistic imagination. \
For example, having superhuman abilities or unusual events or things are mostly a not preferred choice \
unless that is a better solution.
"""
