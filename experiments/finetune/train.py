...
def parse_arguments():
    parser = argparse.ArgumentParser(description="Training Zephyr on Brain Teaser Explain dataset")
    ...
    parser.add_argument("--output_dir", type=str, default="./brain_teaser_explain_zephyr_checkpoints", help="Output directory for checkpoints")
